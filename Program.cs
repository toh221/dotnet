...
namespace bwi40322
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      {
        Console.WriteLine("Datei ein.csv erfolgreich erstellt.\n");
      }
      else
      {
      ...
      while (!reader2.EndOfStream)
      {
        ...
        if (isFirstLine != true)
        {
          ...
          //D er zeitstempel wird auf den Tag eingekürzt
      ...
      // Konsolenausgabe, um den Nutzer ueber den aktuellen Status zu informieren
      Console.WriteLine("Daten werden verdichtet.\n");
      ...
      // Konsolenausgabe, um den Nutzer ueber den aktuellen Status zu informieren
      Console.WriteLine("Datenpaare werden gebildet.\n");
      ...
      {
        Console.WriteLine("Die Datei Namens styles.css wurde erfolgreich erstellt.\n");
      }
      else
      {
        Console.WriteLine("Datei nicht vorhanden.\n");
      ...
      // Hier wird die index.hmtl Datei automatisch im Standardbrowser geoeffnet
      var p = new Process();
      ...
      // Konsolenausgabe, um den Nutzer ueber den aktuellen Status zu informieren
      Console.WriteLine("Die Datei wird im Standardbrowser geöffnet");
      ...
      string AusgabeDatenwert(string[,] strommittel)
      {
        ...
        for (int i = 0; i < strommittel.GetLength(0); i++)
        {
          ...
          // Maximale Ausgabe wird auf 70 Elemente beschränkt
          if (i > 70)
          {
            break;
          }
